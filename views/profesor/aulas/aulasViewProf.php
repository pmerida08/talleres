        ...
        <main>
            ...
            <div class="aulas">
                ...
                foreach ($aulas as $key => $aula) {
                    ...
                    echo "<a href=\"/admin/aulas/edit/" . $aula["id"] . "\"><span class=\"material-symbols-outlined edit\">edit</span></a>";
                    echo "<a href=\"#\" onclick=\"confirmDelete(" . $aula["id"] . ")\"><span class=\"material-symbols-outlined del\">delete</span></a>";
                    echo "</div>";
                    echo "</div>";
            ...
            <?php
            echo "<a href=\"/admin/aulas/add\" class= \"enlaceAdd\">+</a>";
            ?>
        </main>
        <section>
            <h2>Gestiones</h2>
