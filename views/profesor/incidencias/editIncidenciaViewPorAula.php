...
<head>
    ...
    <title>Editar incidencia-Centro Educativo IES Gran Capitán</title>
</head>
...
<body>
    <header>
        ...
        <a href="/aula/<?=$data["idAulaActual"]?>/incidencias" title="Incidencias" class="back-arrow-view">&#8592;</a>       
        <?php
    ...
    <div class="divMainSection">
        ...
        ?>
        <form action="/aula/<?=$data["idAulaActual"]?>/incidencias/edit/<?= $data["id"] ?>" method="post">
            ...
            <label>Fecha de fin:</br>
                <input type="date" name="fecha_fin" value="<?php echo $fechaSolucion; ?>">
            </label>
            </br>
            <input type="submit" name="addSubmit" value="Editar">
            <a href="/aula/<?=$data["idAulaActual"]?>/incidencias" style="background-color: #de1d1d;color: #fff;padding: 10px 20px;border: none;border-radius: 5px;cursor: pointer;font-size: 16px;">Cancelar</a>
        </form>
        </main>
    </div>
    <footer>
