...
<head>
    ...
    <title>Profesores-Centro Educativo IES Gran Capitán</title>
    <script>
        function confirmDelete(profesorId) {
            const confirmation = confirm("¿Estás seguro de que deseas eliminar este profesor?");
            if (confirmation) {
                window.location.href = "/admin/profesores/delete/" + profesorId;
            }
        }
    ...
    <div class="divMainSection">
        <main>
            ...
            <div class="divbusquedaExportarImportar">
                ...
                <a href="/admin/profesores/exportar/">
                ...
                <form id="formArchivo" action="/admin/profesores/importar/" method="post" enctype="multipart/form-data" style="display: none;">
            ...
            <div class="profesores">
                ...
                foreach ($profesores as $key => $profesor) {
                    ...
                    echo "<h2>" . ucfirst($profesor["nombre"]) . "</h2>";
                    echo "<div class= \"deleteEdit\">";
                    echo "<a href=\"/admin/profesores/edit/" . $profesor["id"] . "\"><span class=\"material-symbols-outlined edit\">edit</span></a>";
                    echo "<a href=\"#\" onclick=\"confirmDelete(" . $profesor["id"] . ")\"><span class=\"material-symbols-outlined del\">delete</span></a>";
                    echo "</div>";
                    echo "</div>";
                    echo "<p>" . $profesor["email"] . "</p>";
                    echo "</div>";
                }
                ?>
            </div>
            <?php
            echo "<a href=\"/admin/profesores/add\" class= \"enlaceAdd\">+</a>";
            ?>
        </main>
        <section>
            <h2>Gestiones</h2>
